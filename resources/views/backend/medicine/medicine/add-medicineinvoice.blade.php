                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('medicineinvoice.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control medicine_quantityy" id="medicine_quantityy" value="1"
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input id="medicine_price" class="form-control" name="medicine_price" type="number"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input id="medicine_discount" value="0" class="form-control medicine_discountt" name="medicine_discount" type="number"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input id="medicine_total" class="form-control medicine_totall" name="medicine_total" type="text"
                                    required>
