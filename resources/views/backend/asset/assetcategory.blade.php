        ...
        <div class="row">
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                    href="{{ URL::to('admin/assetcategory/' . $AssetCategory->id . '/edit') }}"><i
                                                        class="fa fa-pencil m-r-5 btn-outline-primary btn"></i> Edit</a>
                                                <a class="dropdown-item" href="#">
                                                    <form action="{{ route('assetcategory.destroy', $AssetCategory->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="card text-left">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Asset Category Add Form</h4>
                        <p class="card-text">
                        <form action="{{ route('assetcategory.store') }}" method="post">
                            @csrf
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" class="btn btn-primary submit-btn">Create Asset Category</button>
                            </div>
                        </form>
                        </p>
                    </div>
