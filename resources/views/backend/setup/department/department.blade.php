                    ...
                    <table class="table table-striped custom-table mb-0 datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="custom-badge @if($Department->dept_status == 'active') ? status-green @else status-red @endif">{{$Department->dept_status}}</span></td>
                        ...
                        <form action="{{ route('department.store') }}" method="post">
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="dept_status" id="product_active" value="active" >
									<label class="form-check-label" for="product_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="dept_status" id="product_inactive" value="inactive">
